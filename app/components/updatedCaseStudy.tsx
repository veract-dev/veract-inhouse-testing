...
export default function UpdatedCaseStudy() {
  ...
  const [selectedTab, setSelectedTab] = useState<String>("edTech");
  ...
  const handleMenuClick = (sectionId: string) => {
    ...
    window.history.pushState(null, "", `/customer-success/?${sectionId}`);
  };
  ...
  const portfolio = [
    {
      ...
      caseTitleContent: (
        <span>
          <span style={{ color: "#4285F4", fontWeight: "bold" }}>Evo11ve</span>{" "}
          is an edtech platform that revolutionizes augmented learning
        </span>
      ),
      stampImage: "",
      caseImage: "/updatedCaseStudiesIcon/edBookPurple.svg",
      challenges:
        "A custom-built, voice-to-text enabled personalized AI coach.",
      challengePoints: " ",
      solution:
        "Veract team designed and developed a desktop application with integrated voice-to-text functionality, implementing advanced noise cancellation features and incorporating seamless chat capabilities.",
      solutionPoints: "",
      services:
        "Software architecture, Technology consulting,Front end development,Back end development,Deployment",
    ...
    },
    {
      ...
      challenges:
        "Over 5 million parts must undergo a comprehensive visual inspection each month. Manual inspection proved to be tedious, and as inspector fatigue set in, accuracy levels declined.",
      challengePoints: "",
      solution:
        "Veract developed a proprietary AI-powered visual inspection tool that significantly boosts productivity and helps prevent part rejections and recalls. The manufacturer deemed the solution a complete success, citing its cost-effectiveness as a key factor.",
      solutionPoints: "",
      services:
        "Software architecture, Technology consulting, Software development, Deployment, End to end vision systems",
      platform: "Web",
    ...
    },
    {
      ...
      caseTitleContent: (
        <span>
          <span style={{ color: "#4285F4", fontWeight: "bold" }}>Anyo</span> is
          a health and wellness app that addresses the significant issue of
          mental health.
        </span>
      ),
      stampImage: "",
      ...
      challenges:
        "The founders of Anyo were looking for a one-stop shop for technical advice and development of their live chat-enabled platform with streaming audio, video and chatbots.",
      challengePoints: "",
      ...
      solutionPoints: "",
      services:
        "Software architecture, Technology consulting, Software development, Deployment",
      platform: "Mobile, Web ",
    ...
    },
    {
      ...
      caseTitleContent: (
        <span>
          ...
          is an initiative of IBITS.
        </span>
      ),
      stampImage: "",
      caseImage: "/updatedCaseStudiesIcon/socialPurple.svg",
      challenges:
        "Challenged with creating a comprehensive platform tailored specifically for the data center industry including post content, comment, like, and share within the community, with a integrated marketplace for products and services and a directory of suppliers specializing in data center solutions.",
      challengePoints: " ",
      solution:
        " Developed a robust e-commerce  and social  platform tailored. The site features a robust backend system for managing product listings and user accounts. It includes functionalities like marketplace, quote requests, product filtering, and content management.",
      solutionPoints: "",
      services:
        "Design Software architecture,Technology consulting,Front end development,Back end development,Deployment",
      platform: "Web",
    ...
    },
    {
      ...
      caseTitleContent:
        "An automated quality report generation system for Grey Iron and Ductile Iron Foundry.",
      stampImage: "",
      caseImage: "/output/quality_documetation_logo.svg",
      challenges:
        "Submission of parts necessitates the submission of high-quality documentation on spectrometer readings, pouring properties, mould properties and sand properties.",
      challengePoints: " ",
      solution:
        "A one-stop shop that combines machine maintenance, defect prediction, CAPA follow-up, test certificate and other quality documents.",
      solutionPoints: "",
      services:
        "Software architecture, Technology consulting, Software development, Deployment",
      platform: "Web",
      techstack:
        "Bootstrap,Express.js,jQuery,MongoDB,Redis,IndexedDB,Google APIs",
      name: "",
      designation: "",
      company: "",
      clientSpeak: "",
    ...
    },
    {
      ...
      caseTitleContent: (
        <span>
          Agrosperity{" "}
          <span style={{ color: "#4285F4", fontWeight: "bold" }}>KiVi</span> is
          a phygital platform in the area of agri supply chain and financing.
        </span>
      ),
      stampImage: "",
      caseImage: "/updatedCaseStudiesIcon/agriTechPurple.svg",
      challenges:
        "KiVi was seeking a development partner to fully assume responsibility for the design, development and implementation of Vision to text, Map interfaces for loan eligibility data, loan documents automation, dashboards with multiple authentication levels.",
      challengePoints: "",
      solution:
        "Veract architects set up the platform and assumed complete ownership of the product and made critical choices of architecture, framework to enable rapid development.",
      solutionPoints: "",
      services:
        "Software architecture, Technology consulting, Software development, Deployment",
      platform: "web",
      techstack:
        "Java, Spring Boot, PostgreSQL,Nginx,Kafka,Elasticsearch,Google APIs,CI/CD,Angular,Kibana",
      name: "Salil Nair",
      designation: "CTO",
      company: "Agrosperity Tech Solutions",
      clientSpeak:
        "We engaged with Veract team from an early stage and they helped build out our 'KiViStar' App from basic day one concept. Their choice of architecture, framework and ability to deliver the product helped us go to market quickly. This helped us focus on our core work.",
      seperator: <hr className="separatorPortfolio"></hr>,
    },
    {
      id: "eCommerce",
      ...
      caseTitleContent: (
        <span>
          ...
          operates in the exciting farm-to-table space.
        </span>
      ),
      stampImage: "",
      caseImage: "/updatedCaseStudiesIcon/eComPurple.svg",
      challenges:
        "Payment enabled e-commerce site in time for customers produce season.",
      challengePoints: " ",
      solution:
        "Veract team developed and deployed a payment enabled custom designed web application. ",
      solutionPoints: "",
      services:
        "Software architecture,Technology consulting,Front end development,Back end development ,Deployment",
      platform: "Web",
    ...
    },
    {
      ...
      caseTitleContent: (
        <span>
          <span style={{ color: "#4285F4", fontWeight: "bold" }}>Rajdeep</span>{" "}
          is a distributor of industrial products with multiple principals,
      ...
      challenges:
        "Salesman attrition, inconsistent data, quotation production and reporting were the client's pain concerns. Customer was searching for a solution that would operate with SAP integration and fit into their usual routine.",
      challengePoints: "",
      solution:
        "Veract created a mobile and online application that seamlessly integrated with the customers existing software.",
      solutionPoints: "",
      services:
        "Software architecture, Technology consulting, Software development, Deployment",
      platform: "Mobile,Web",
      techstack:
        "Redis,Bootstrap,Express.js,IndexedDB,MongoDB,Google APIs,jQuery",
      name: "ANAND SHAH",
    ...
    },
    {
      ...
      challengePoints: " ",
      solution:
        "Veract team developed and deployed a easy to use Large language model +OCR based custom trained data extraction capability ",
      solutionPoints: "",
      services:
        "Software architecture,Technology consulting,Front end development,Back end development ,Deployment",
      platform: "Web",
    ...
    },
    {
      ...
      caseTitleContent: (
        <span>
          ...
          is a financial services platform that was established primarily to
          meet various credit needs of businesses and households that are
          underserved.
        </span>
      ),
      stampImage: "",
      ...
      challenges:
        "For the construction of their investor portal, Northern Arc Capital required a team with technical and financial domain experience. They needed to reduce risk by using risk analytics, risk profiles, etc.",
      challengePoints: " ",
      solution:
        "Veract implemented risk profiling in their investor tracking portal by fusing their core development skills with their expertise in financial domain.",
      solutionPoints: "",
      services:
        "Software architecture, Technology consulting, Software development, Deployment",
      platform: "Web",
    ...
    },
    {
      ...
      caseTitleContent:
        "The Institute of Buffalo Science focuses on improving buffalo health monitoring by tracking key parameters and mapping udder thermal profiles to detect early onset of mastitis in dairy animals.",
      stampImage: "",
      caseImage: "/updatedCaseStudiesIcon/thermalPurple.svg",
      challenges:
        "Integration of the thermal imaging camera with the monitoring system and IOT. Ensuring real-time data capture and processing. Compatibility between the camera hardware and software solutions. Reliable data transfer protocols to minimize latency.",
      challengePoints: " ",
      solution:
        "Software Development: Created custom software for real-time analysis and visualization of udder thermal profiles and camera control through a user-friendly interface.",
      solutionPoints: "",
      services:
        "Software architecture, Technology consulting, Front end development, Back end development, Deployment",
      platform: "Web",
...
useEffect(()=>{
  ...
  const handleLoad = () => {
    // Use setTimeout to ensure all content is rendered before hiding the loader
    setTimeout(() => {
      setIsLoading(false);
    }, 500);
  };
  ...
  useEffect(() => {
    ...
    const section = urlParams.keys().next().value || "";
    ...
    if (section) {
      ...
      setSelectedTab("edTech");
      router.push("/customer-success/?edTech");
    }

    // Add this section to ensure complete loading


    // Check if document is already loaded

  }, [searchParams]);
  // window.history.replaceState(null, '', `/customer-success/?category=${selectedTab}`); // Fix typo in URL path
      ...
      scrollTimeout = setTimeout(() => {
        ...
        if (closestSection !== null && closestSection !== selectedTab) {
          ...
          window.history.pushState(
            null,
            "",
            `/customer-success/?${closestSection}`
          );
        }
      ...
      {isLoading ? (
        <div className="fixed inset-0 flex items-center justify-center bg-white z-50">
          <div className="text-xl font-semibold animate-pulse">
            <span className="font-semibold text-6xl">ver</span>
            <span className="textColorLogo text-6xl">act</span>
          </div>
        </div>
      ) : (
        <div className="desktopCaseStudy">
          <div id="portfolioDetails" className="fontFamily">
            <div
              className={`dashboard h-[74.5vh] transition-all duration-300 ${
                isVisible ? "translate-y-[-10%]" : ""
              } overflow-auto `}
              id="container"
            >
                ...
                >
                  ...
                  <div
                    className={`flex items-center ${
                      selectedTab === item.id ? `text-white` : `text-[#7F7F7F]`
                    }`}
                  >
                    {item.title}
                  </div>
                  {item.hasAi && (
                    <img
                      src="/updatedCaseStudiesIcon/aiStamp.svg"
                      alt=""
                      className=""
                    />
                  )}
              ...
              >
                <div
                  className={`caseDetails ${
                    selectedTab === item.id ? "pt-[10%]" : "pt-[5%]"
                  }`}
                >
                  <div className="w-[95%] flex flex-col gap-[1rem] mt-[2rem] pb-[1rem]">
                    <div className="flex flex-row gap-[2.688rem] items-center mt-[0.5rem]">
                      <img
                        src={item.caseImage}
                        alt=""
                        className="w-[4.563rem] aspect-square"
                      />
                      <div className="text-[32px] font-semibold text-[#4285f4]">
                        {item.caseTitle}
                      </div>
                    </div>
                    <div className="text-[18px] font-normal text-black">
                      {item.caseTitleContent}
                    </div>
                  </div>
                  <div className="w-[95%] flex flex-row justify-between">
                    <div className="w-[45%] p-[2rem] bg-white rounded-[26px] flex flex-col gap-[0.5rem] caseStudyContainerBoxShadow">
                      <div className="text-[18px] text-[#4285f4] font-semibold text-center">
                        Challenge
                      </div>
                    ...
                    <div className="w-[30%] max-h-[17rem] p-[2rem] bg-white rounded-[26px] flex flex-col items-center gap-[0.5rem] caseStudyContainerBoxShadow">
                      ...
                      <div className="flex flex-col">
                        {item.services.split(",").map((service, index) => (
                          <div
                            key={index}
                            className="text-[16px] text-black font-normal text-center"
                          >
                            {service}
                          </div>
                        ))}
                    ...
                    <div className="w-[30%] max-h-[17rem] p-[2rem] bg-white rounded-[26px] flex flex-col items-center gap-[0.5rem] caseStudyContainerBoxShadow">
                      ...
                      <div className="flex flex-col gap-[0.25rem] mt-[0.25rem]">
                        {item.platform.split(",").map((temp, index) => (
                          <div key={index} className="PlatformText">
                            {temp}
                          </div>
                        ))}
                      </div>
                      ...
                      <div className="flex flex-row gap-[1.25rem]">
                        <div className="flex flex-col gap-[0.25rem]">
                          {item.techstack
                            ...
                            .slice(
                              0,
                              Math.ceil(item.techstack.split(",").length / 2)
                            )
                            .map((stack, index) => (
                              <div key={index} className="techText text-center">
                                {stack}
                              </div>
                            ))}
                        </div>
                  ...
                  {item.clientSpeak?.length !== 0 && (
                    <div className="testimonialContainer rounded-[26px] caseStudyContainerBoxShadow">
                      <div className="clientContainer border-none md:gap-4">
                        ...
                        <div className="challengesContent pl-2 pr-2 flex-wrap pb-2">
                          {item.clientSpeak}
                        </div>
                        <div className="flex justify-end">
                          <i className="quotesEnd"></i>
                        </div>
                      </div>
                    </div>
                  )}
